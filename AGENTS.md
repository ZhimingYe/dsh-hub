...
- Operator docs: [README.md](README.md) (English first) and [README.zh.md](README.zh.md). Publish by syncing this directory to the sibling `dsh-hub` git repo (`hub/scripts/sync-to-dsh-hub.sh`, default `../dsh-hub`, remote `github.com/ZhimingYe/dsh-hub`).
